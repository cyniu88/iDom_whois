...
define Package/iDom_whois/description
...
define Package/iDom_whois/install
	$(INSTALL_DIR) $(1)/usr/bin
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/iDom_whois $(1)/usr/bin/iDom_whois
endef

$(eval $(call BuildPackage,libiwinfo))
$(eval $(call BuildPackage,libiwinfo-lua))
$(eval $(call BuildPackage,iDom_whois))
